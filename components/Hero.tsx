...
export default function Hero() {
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <Image
        src="/hero.jpg"
        alt="Mina Adel - Digital Imaging Technician"
        fill
        priority
        sizes="100vw"
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl">
        ...
        <h2 className="mt-6 text-xl md:text-3xl font-light tracking-wide">
          Digital Imaging Technician • Camera Systems Specialist
        </h2>

        <p className="mt-8 text-gray-300 text-lg leading-8 max-w-3xl mx-auto">
          Professional Digital Imaging Technician specializing in feature films,
          television series, commercials, and international productions.
          Delivering reliable on-set workflows, secure media management,
          camera support, and professional DIT solutions.
        </p>
